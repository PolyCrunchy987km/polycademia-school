...
export class Polyline extends ObjetMathalea2D {
    constructor(...args) {
        ...
        this.listePoints = pts.filter((el) => el instanceof PointAbstrait);
        this.listePoints3d = pts.filter((el) => el && typeof el === 'object' && 'c2d' in el);
        // Couleur
        this.stringColor = colorArg !== null && colorArg !== void 0 ? colorArg : 'black';
