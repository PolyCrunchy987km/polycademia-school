...
export class MathAleaURL extends URL {
    ...
    static fromExercisesParams() {
        ...
        for (const ex of params) {
            ...
            if (ex.versionQcm != null)
                url.searchParams.append('qcm', ex.versionQcm);
            if (ex.alea != null)
...
export function buildMathAleaURL(options) {
    ...
    if (options.view === 'can') {
        ...
        url
            .addParam('canD', ((_a = can.durationInMinutes) !== null && _a !== void 0 ? _a : 1).toString())
        ...
        const title = (_b = global.title) !== null && _b !== void 0 ? _b : 'Évaluation';
        if (title !== '') {
 ...
 */
export function buildEsParams(mode) {
    var _a, _b;
    ...
    es += presentationMode.get(mode !== undefined ? mode : ((_a = options.presMode) !== null && _a !== void 0 ? _a : 'liste_exos'));
    es += (_b = options.setInteractive) !== null && _b !== void 0 ? _b : '2';
...
export function decrypt(url) {
    ...
    if (part2withEEEE.substring(0, 4) !== 'EEEE') {
        ...
        if (matches !== null) {
            part2 = matches.reduce((acc, char) => acc + String.fromCharCode(parseInt(char, 16)), '');
        }
