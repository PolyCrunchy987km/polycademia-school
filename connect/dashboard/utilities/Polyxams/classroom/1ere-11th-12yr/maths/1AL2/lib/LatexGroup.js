 ...
 *
 */
export function decodeExosGrouping(value, maxExos) {
 ...
 */
export function findExoPosition(groups, exo) {
...
export function getPoints(exercice) {
    let points = 0;
...
export function buildExamExercices(exercices, latexFileInfos) {
    const grouping = latexFileInfos === null || latexFileInfos === void 0 ? void 0 : latexFileInfos.exosGrouping;
    if (!grouping) {
