...
import { mathaleaGoToView, mathaleaWriteStudentPreviousAnswers, } from './mathaleaUtils';
...
import { capytaleMode, capytaleStudentAssignment, exercicesParams, resultsByExercice, } from './stores/generalStore';
...
export let answersFromCapytale = [];
export let assignmentDataFromCapytale = {};
 ...
 */
async function toolSetActivityParams({ mode, activity, workflow, studentAssignment, assignmentData, }) {
    ...
    if ((newCanOptions === null || newCanOptions === void 0 ? void 0 : newCanOptions.isChoosen) && mode !== 'create') {
            ...
            if (exercice != null &&
                ...
                exercicesParams.update((l) => {
                    if (Array.isArray(l)) {
                        ...
                        l[exercice.indice].bestScore = exercice.bestScore;
                    }
                    return l;
                });
            }
    ...
    if (mode !== 'create') {
        // Vue élève
        if (newCanOptions === null || newCanOptions === void 0 ? void 0 : newCanOptions.isChoosen) {
    ...
    if (studentAssignment != null) {
                    ...
                    if (exercice.type === 'app') {
                        ...
                        if (exercice != null) {
                            const message = {
                                ...
                                score: exercice === null || exercice === void 0 ? void 0 : exercice.numberOfPoints,
                                numeroExercice: exercice === null || exercice === void 0 ? void 0 : exercice.indice,
                                numberOfQuestions: exercice === null || exercice === void 0 ? void 0 : exercice.numberOfQuestions,
                                finalState: exercice === null || exercice === void 0 ? void 0 : exercice.answers,
                            };
        ...
        if (!canOptions.isChoosen) {
            ...
            for (const exercice of studentAssignment) {
                ...
                const buttonScore = document.querySelector(`#buttonScoreEx${exercice === null || exercice === void 0 ? void 0 : exercice.indice}`);
                if (buttonScore !== null) {
    ...
    if (canOptions.isChoosen) {
        if (canOptions.state !== 'canHomeScreen')
            return;
        let newState = 'start';
        if (mode === 'review') {
...
export function sendToCapytaleSaveStudentAssignment({ indiceExercice, assignmentData, }) {
    var _a, _b, _c, _d;
    if (indiceExercice === undefined)
        return;
    ...
    for (const resultExercice of results) {
        if (Number.isFinite(resultExercice === null || resultExercice === void 0 ? void 0 : resultExercice.numberOfPoints)) {
    ...
    if (currentMode === 'assignment') {
        ...
        if (indiceExercice !== 'all') {
            ...
            const bestScore = (_b = (_a = results[indiceExercice]) === null || _a === void 0 ? void 0 : _a.bestScore) !== null && _b !== void 0 ? _b : 0;
            const newScore = (_d = (_c = results[indiceExercice]) === null || _c === void 0 ? void 0 : _c.numberOfPoints) !== null && _d !== void 0 ? _d : -1;
        ...
        promiseSaveStudentAssignment
            ...
            if (err instanceof Error &&
                ...
                showDialogStringMessageForLimitedTime('Impossible de sauvegarder vos réponses car votre copie est déjà rendue.', 5000);
                return;
            }
            if (err instanceof Error &&
                err.message &&
                err.message.includes('Copie verrouillée')) {
                showDialogStringMessageForLimitedTime('Impossible de sauvegarder vos réponses car votre copie est verrouillée.', 5000);
                return;
            }
            ...
            if (err === null || err === void 0 ? void 0 : err.data) {
            ...
            const message = [
                ...
                ((_a = err === null || err === void 0 ? void 0 : err.data) === null || _a === void 0 ? void 0 : _a.message) && `data.message: ${(_b = err === null || err === void 0 ? void 0 : err.data) === null || _b === void 0 ? void 0 : _b.message}`,
                ((_c = err === null || err === void 0 ? void 0 : err.error) === null || _c === void 0 ? void 0 : _c.message) && `error.message: ${(_d = err === null || err === void 0 ? void 0 : err.error) === null || _d === void 0 ? void 0 : _d.message}`,
            ]
                .filter(Boolean)
                .join('\n');
            window.notify(`Problème avec la sauvegarde Capytale: ${(_e = err.message) !== null && _e !== void 0 ? _e : 'Erreur inconnue'}`, {
                error: err,
                message,
                mode: currentMode,
                indiceExercice,
...
export default async function handleCapytale() {
    ...
    try {
        const activityParams = await rpc.call('toolGetActivityParams', {});
