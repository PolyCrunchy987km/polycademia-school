...
export class PointAbstrait extends ObjetMathalea2D {
    constructor(arg1, arg2, arg3, positionLabel = 'above') {
        super();
...
export function pointAbstrait(x, y, A = '', positionLabel = 'above') {
    return new PointAbstrait(x, y, A, positionLabel);
}
export function isPointAbstrait(objet) {
    return objet instanceof PointAbstrait;
}
export function isPointsAbstraits(objets) {
 ...
 */
export function point(x, y, nom = '', positionLabel = 'above') {
    return new PointAbstrait(x, y, nom, positionLabel);
}
export const IToPointAbstrait = (point) => pointAbstrait(point.x, point.y, point.nom, point.positionLabel);
